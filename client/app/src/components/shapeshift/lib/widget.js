(function () {
  ...
  app.directive('coinError', ['ShapeShiftApiService', (ShapeShiftApiService) => {
    return {
      require: ['^coinTrader'],
      restrict: 'E',
      transclude: true,
  ...
  app.directive('coinShiftButton', ['ShapeShiftApiService', (ShapeShiftApiService) => {
    return {
      require: ['^coinTrader'],
      restrict: 'E',
      transclude: true,
  ...
  app.directive('coinDepositInfo', ['ShapeShiftApiService', (ShapeShiftApiService) => {
    return {
      require: ['^coinTrader'],
      restrict: 'E',
      transclude: true,
  ...
  app.directive('coinSelector', ['ShapeShiftApiService', (ShapeShiftApiService) => {
    return {
      require: ['^coinTrader'],
      restrict: 'E',
      transclude: true,
  ...
  app.directive('coinTrader', ['$interval', 'ShapeShiftApiService', ($interval, ShapeShiftApiService) => {
    return {
      restrict: 'E',
      transclude: true,
  ...
  app.service('ShapeShiftApiService', ($q) => {
    const SSA = new ShapeShift.ShapeShiftApi() // eslint-disable-line no-undef
    return {
      coins: function () {
